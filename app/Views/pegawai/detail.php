            ...
            <div class="row content-panel">
              <div class="col-md-4 profile-text mt mb centered">
                <div class="right-divider hidden-sm hidden-xs">
                  <h4><?= $pegawai['nip']; ?></h4>
                  <h6>NIP</h6>
                  <h4><?= $pegawai['spesialis']; ?></h4>
                  <h6>Spesialis</h6>
                  <h4><?= $pegawai['jabatan'] ?></h4>
                  <h6>Jabatan</h6>
                </div>
              </div>
              <!-- /col-md-4 -->
              ...
              <div class="col-md-4 centered">
                <div class="profile-pic">
                  ...
                  <p>
                    <button class="btn btn-theme"><i class="fa fa-check"></i><?= $pegawai['agama']; ?></button>
                    <button class="btn btn-theme02"><?= $pegawai['status']; ?></button>
                  </p>
                </div>
              </div>
              <!-- /col-md-4 -->
